...
final normalization and width scaling. Committed history lengths exclude the
pending verify window. This configuration does not require EAGLE tree support;
DSpark TP2 and pipeline parallelism are outside the validated deployment scope.
